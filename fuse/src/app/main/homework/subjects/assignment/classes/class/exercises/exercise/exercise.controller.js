(function () {
  ...
  /** @ngInject */
  function ExerciseController($timeout, breadcrumbs, breadcrumb, tableTree, $scope, $state, $document, loadingScreen, $q, generalMessage, Restangular, $mdDialog) {
    var vm = this;
    ...
    vm.assignDifficulty = function (ev, item) {
      $mdDialog.show({
        controller: function ($scope, $rootScope, weakness, isExamination, isExercise, isDisableEdit, $mdDialog) {
          ...
          vm.types = [{ name: 'MC', value: 0 }, { name: 'Short Question', value: 1 }, {
            name: 'Long Question',
            value: 2
          }, { name: 'Matching', value: 3 }];
