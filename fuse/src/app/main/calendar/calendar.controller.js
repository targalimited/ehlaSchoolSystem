(function ()
{
    ...
    function CalendarController($mdDialog, $timeout, $mdSticky, $document, $scope, breadcrumbs, loadingScreen, generalMessage, Restangular)
    {
        ...
        $scope.events = {};
        vm.eventTypes = [
            { name: 'My Teaching Events', type: 'private', color: 'rgb(164, 122, 226)', disableColor: 'rgb(164, 122, 226, 0.2)' },
            ...
            { name: 'Examinations', type: 'examination', color: 'rgb(208, 107, 100)', disableColor: 'rgb(208, 107, 100, 0.2)' },
