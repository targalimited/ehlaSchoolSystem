      ...
      <div slot="item" slot-scope="{item}" class="vi-table__row">
        ...
        <vi-table-col>
          <vi-item>
            ...
            <vi-item-content>
              <vi-item-title>{{item.student_detail && item.student_detail.username}}</vi-item-title>
              <vi-item-subtitle>{{item.student_detail && item.student_detail.realname_en}}</vi-item-subtitle>
            </vi-item-content>
          </vi-item>
        </vi-table-col>
