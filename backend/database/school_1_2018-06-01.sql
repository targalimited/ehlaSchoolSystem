...
# Database: school_1
# Generation Time: 2018-06-01 12:19:42 +0000
# ************************************************************
...
# Dump of table school_debugs
# ------------------------------------------------------------

DROP TABLE IF EXISTS `school_debugs`;

CREATE TABLE `school_debugs` (
...
# Dump of table school_migrations
# ------------------------------------------------------------

DROP TABLE IF EXISTS `school_migrations`;

CREATE TABLE `school_migrations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `school_migrations` WRITE;
/*!40000 ALTER TABLE `school_migrations` DISABLE KEYS */;

INSERT INTO `school_migrations` (`id`, `migration`, `batch`)
VALUES
	(2,'2018_05_14_050112_create_users_table',1),
	(4,'2018_06_01_031205_create_debugs_table',2);

/*!40000 ALTER TABLE `school_migrations` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `school_permission_role` (`permission_id`, `role_id`)
VALUES
	(1,5),
	(1,6),
	(1,7),
...
/*!40000 ALTER TABLE `school_permission_role` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `school_permissions` (`id`, `name`, `display_name`, `description`, `created_at`, `updated_at`)
VALUES
...
CREATE TABLE `school_role_user` (
  ...
  CONSTRAINT `school_role_user_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `school_users_backup` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
VALUES
	(12,742,1,'2018-05-26 05:26:07','2018-05-26 05:26:07'),
	(13,743,1,'2018-05-26 05:26:08','2018-05-26 05:26:08'),
	(14,744,2,'2018-05-26 05:26:08','2018-05-26 05:26:08');
...
VALUES
	(7,6,742,NULL,NULL,NULL),
	(8,6,743,NULL,NULL,NULL),
	(9,7,744,NULL,NULL,NULL),
	(13,11,742,NULL,NULL,NULL),
	(14,11,743,NULL,NULL,NULL),
	(15,12,744,NULL,NULL,NULL);
...
VALUES
	(6,718,1,2,0,NULL,NULL,'2018-05-28 16:32:08','2018-05-28 16:32:08'),
	(7,718,2,2,0,NULL,NULL,'2018-05-28 16:32:08','2018-05-28 16:32:08'),
	(8,718,3,2,0,NULL,NULL,'2018-05-28 16:32:08','2018-05-28 16:32:08'),
	(11,719,1,1,0,NULL,NULL,'2018-05-28 16:33:15','2018-05-28 16:33:15'),
	(12,719,2,1,0,NULL,NULL,'2018-05-28 16:33:15','2018-05-28 16:33:15');
...
CREATE TABLE `school_users` (
  ...
  `ex_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
# Dump of table school_users_backup
# ------------------------------------------------------------

DROP TABLE IF EXISTS `school_users_backup`;

CREATE TABLE `school_users_backup` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `usermodel_user_id` int(10) unsigned NOT NULL,
  ...
  `plain_text_password` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

LOCK TABLES `school_users_backup` WRITE;
/*!40000 ALTER TABLE `school_users_backup` DISABLE KEYS */;

INSERT INTO `school_users_backup` (`id`, `usermodel_user_id`, `username`, `email`, `password`, `user_group`, `sc_token`, `fb_token`, `acc_type`, `status`, `is_deleted`, `create_ts`, `update_ts`, `school_id`, `name`, `remember_token`, `student_id`, `plain_text_password`)
VALUES
	(66,0,'ggg','ggg@gmail.com','e10adc3949ba59abbe56e057f20f883e',3,'','','paying','active',0,'2016-12-26 10:38:06','2018-02-26 03:24:47',NULL,NULL,'niYYVEoR7Q1J7nRByOfhlXP3IswrH6yJohFjPAdqj4Mhw2k7yjUOKXg3E4N1',NULL,NULL),
	(718,0,'Peter Chen','pc@school1.com','$2y$10$mkvXOx8mwtLHwM0G5Y77ZuXVnQVGW6B1g1OTygh/lHEAC5DimXTkm',3,'','','paying','non-active',0,'2018-05-14 13:27:16','2018-05-28 16:32:08',NULL,NULL,NULL,NULL,NULL),
	(719,0,'May Lam','ml@school1.com','$2y$10$UFgbO4ET1ujQuBKnDjCctuGT.Feq34XzWELBitLwVZ.xWeJzANchu',3,'','','paying','non-active',0,'2018-05-14 13:27:16','2018-05-28 16:33:15',NULL,NULL,NULL,NULL,NULL),
	(739,0,'Chan Tai Ming','ctm@student.com','$2y$10$ao4qwB/qBzPU4IZNsqbP1./R3YxxP/VeCTO5q9t7KJRjX3YdTVU8q',3,'','','paying','non-active',0,'2018-05-26 04:44:04','2018-05-26 05:26:08',NULL,NULL,NULL,NULL,NULL),
	(740,0,'Lau Wing Ki','lwk@student.com','$2y$10$7yyPZhMNH3pmlasy6nsqruA9iyjQjw47PfraVRSFiqP75W06XxB/W',3,'','','paying','non-active',0,'2018-05-26 04:44:04','2018-05-26 05:26:08',NULL,NULL,NULL,NULL,NULL),
	(741,0,'Leung wai Ming','lwm@student.com','$2y$10$sDixsxuvsnx7fZqnQGxEJeYxw71xNCLNOB1Twtk6S4xLm5f35tKVS',3,'','','paying','non-active',0,'2018-05-26 04:44:04','2018-05-26 05:26:08',NULL,NULL,NULL,NULL,NULL);

/*!40000 ALTER TABLE `school_users_backup` ENABLE KEYS */;
UNLOCK TABLES;
